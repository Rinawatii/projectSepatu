...
public class BarangInputFrame extends JFrame {
    ...
    private JComboBox namabarangcomboBox;
    ...
    public void isiKomponen() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                jenisTextField.setText(rs.getString("merk"));
                warnaTextField.setText(rs.getString("warna"));
                tanggalDatePicker.setText(rs.getString("tglpembelian"));
        ...
        simpanButton.addActionListener(e -> {
            ...
            try {
                if (this.id == 0) { //jika TAMBAH
                    ...
                    String insertSQL = "INSERT INTO barang (id, nama, pembeli_id,jenis, ukuran,warna, tanggalpembelian)" +
                            "VALUES (NULL, ?,?,?,?,?,?,?)";
